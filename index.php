...
<head>
    ...
    grecaptcha.ready(function() {
        grecaptcha.execute('your-public-key', {
            action: 'verify'
        }).then(function(token) {
        ...
        <div class="ui styled fluid accordion">
            ...
            <div class="active content">
                <table class="ui celled table" width="100%">
                    <tr>
                        <td>玩家名:<?php echo json_decode(json_encode($dkjson['data']['playername']));?></td>
                    </tr>
                    <tr>
                        <td>UUID:<?php echo json_decode(json_encode($dkjson['data']['uuid'])); ?> </td>
                    </tr>
                    <tr>
                        <td>加入服务器时间:<?php $join = json_decode(json_encode($dkjson['data']['time_start'])); if(!empty($join)){echo date('Y-m-d H:i:s', $join / 1000);} ?>
                        </td>
                    </tr>
                    <tr>
                        <td>上次在线时间:<?php $seen = json_decode(json_encode($dkjson['data']['time_last'])); if(!empty($seen)){echo date('Y-m-d H:i:s', $seen / 1000);} ?>
                        </td>
                    </tr>
                    <tr>
                        <td>在线时长:<?php $online = json_decode(json_encode($dkjson['data']['time_lived'])); if(!empty($seen)){echo round($online / 3600,2)." h";} ?>
                        </td>
                    </tr>
                    <tr>
                        <td>是否被ban:<?php if($ban != "notpass"){ if(!empty($_POST["post"])){ echo $ban ? '是':'否'; }}?>
                        </td>
                    </tr>
                    <tr>
                        <td>数据更新时间:<?php $update = json_decode(json_encode($dkjson['data']['lastUpdate'])); if(!empty($update)){echo date('Y-m-d H:i:s', $update / 1000);} ?>
                        </td>
                    </tr>
                </table>
            </div>
                ...
                <table class="ui celled table" width="100%">
                    <tr>
                        <td width="30%">
                            ...
                            <div class="ui flowing popup transition top left hidden">
                                <div class="ui two column divided equal height center aligned grid">
                                    <div class="column">
                                        <h4 class="ui header advTitle_parent"></h4>
                                        （无）
                                    </div>
                                    <div class="column">
                                        <h4 class="ui header advTitle_requirements"></h4>
                                        在物品栏中获得工作台。
                                    </div>
                                </div>
                            </div>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/root']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/root']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:story/root']['criteria']['crafting_table'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/mine_stone']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/mine_stone']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:story/mine_stone']['criteria']['get_stone'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/upgrade_tools']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/upgrade_tools']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:story/upgrade_tools']['criteria']['stone_pickaxe'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/smelt_iron']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/smelt_iron']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:story/smelt_iron']['criteria']['iron'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/obtain_armor']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/obtain_armor']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:story/obtain_armor']['criteria']['iron_chestplate'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/lava_bucket']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/lava_bucket']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:story/lava_bucket']['criteria']['lava_bucket'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/iron_tools']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/iron_tools']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:story/iron_tools']['criteria']['iron_pickaxe'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/deflect_arrow']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/deflect_arrow']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:story/deflect_arrow']['criteria']['deflected_projectile'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/form_obsidian']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/form_obsidian']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:story/form_obsidian']['criteria']['obsidian'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/mine_diamond']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/mine_diamond']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:story/mine_diamond']['criteria']['diamond'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/enter_the_nether']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/enter_the_nether']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:story/enter_the_nether']['criteria']['entered_nether'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/shiny_gear']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/shiny_gear']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:story/shiny_gear']['criteria']['diamond_boots'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/enchant_item']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/enchant_item']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:story/enchant_item']['criteria']['enchanted_item'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/cure_zombie_villager']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/cure_zombie_villager']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:story/cure_zombie_villager']['criteria']['cured_zombie'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/follow_ender_eye']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/follow_ender_eye']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:story/follow_ender_eye']['criteria']['in_stronghold'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/enter_the_end']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:story/enter_the_end']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:story/enter_the_end']['criteria']['entered_end'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/root']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/root']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:nether/root']['criteria']['entered_nether'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/return_to_sender']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/return_to_sender']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:nether/return_to_sender']['criteria']['killed_ghast'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/fast_travel']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/fast_travel']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:nether/fast_travel']['criteria']['travelled'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/find_fortress']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/find_fortress']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:nether/find_fortress']['criteria']['fortress'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/uneasy_alliance']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/uneasy_alliance']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:nether/uneasy_alliance']['criteria']['killed_ghast'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/get_wither_skull']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/get_wither_skull']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:nether/get_wither_skull']['criteria']['wither_skull'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/obtain_blaze_rod']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/obtain_blaze_rod']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:nether/obtain_blaze_rod']['criteria']['blaze_rod'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/summon_wither']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/summon_wither']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:nether/summon_wither']['criteria']['summoned'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/brew_potion']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/brew_potion']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:nether/brew_potion']['criteria']['potion'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/create_beacon']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/create_beacon']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:nether/create_beacon']['criteria']['beacon'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/all_potions']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/all_potions']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:nether/all_potions']['criteria']['all_effects'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/create_full_beacon']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/create_full_beacon']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:nether/create_full_beacon']['criteria']['beacon'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/all_effects']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:nether/all_effects']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:nether/all_effects']['criteria']['all_effects'],true),true));?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/root']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/root']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:end/root']['criteria']['entered_end'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/kill_dragon']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/kill_dragon']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:end/kill_dragon']['criteria']['killed_dragon'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/dragon_egg']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/dragon_egg']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:end/dragon_egg']['criteria']['dragon_egg'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/enter_end_gateway']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/enter_end_gateway']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:end/enter_end_gateway']['criteria']['enter_end_gateway'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/respawn_dragon']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/respawn_dragon']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:end/respawn_dragon']['criteria']['summoned_dragon'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/dragon_breath']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/dragon_breath']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:end/dragon_breath']['criteria']['dragon_breath'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/find_end_city']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/find_end_city']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:end/find_end_city']['criteria']['in_city'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/elytra']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/elytra']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:end/elytra']['criteria']['elytra'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/levitate']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:end/levitate']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:end/levitate']['criteria']['levitated'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/root']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/root']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/root']['criteria']['killed_something'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/voluntary_exile']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/voluntary_exile']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/voluntary_exile']['criteria']['voluntary_exile'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/kill_a_mob']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/kill_a_mob']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/kill_a_mob']['criteria']['minecraft:zombie'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/trade']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/trade']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/trade']['criteria']['traded'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/honey_block_slide']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/honey_block_slide']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/honey_block_slide']['criteria']['honey_block_slide'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/ol_betsy']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/ol_betsy']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/ol_betsy']['criteria']['shot_crossbow'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/sleep_in_bed']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/sleep_in_bed']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/sleep_in_bed']['criteria']['slept_in_bed'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/hero_of_the_village']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/hero_of_the_village']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/hero_of_the_village']['criteria']['hero_of_the_village'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/throw_trident']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/throw_trident']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/throw_trident']['criteria']['shot_trident'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/shoot_arrow']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/shoot_arrow']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/shoot_arrow']['criteria']['shot_arrow'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/kill_all_mobs']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/kill_all_mobs']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td class=""><?php echo '
<div class="ui list">
<div class="item">';
...
'; ?></td>
                    ...
                    <tr>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/totem_of_undying']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/totem_of_undying']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/totem_of_undying']['criteria']['used_totem'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/summon_iron_golem']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/summon_iron_golem']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/summon_iron_golem']['criteria']['summoned_golem'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/two_birds_one_arrow']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/two_birds_one_arrow']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/two_birds_one_arrow']['criteria']['two_birds'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/whos_the_pillager_now']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/whos_the_pillager_now']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/whos_the_pillager_now']['criteria']['kill_pillager'],true),true));?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/arbalistic']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/arbalistic']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/arbalistic']['criteria']['arbalistic'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/adventuring_time']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/adventuring_time']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td class=""><?php echo '
<div class="ui list">
<div class="item">';
...
'; ?> </td>
                    ...
                    <tr>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/very_very_frightening']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/very_very_frightening']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/very_very_frightening']['criteria']['struck_villager'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/sniper_duel']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/sniper_duel']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/sniper_duel']['criteria']['killed_skeleton'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/root']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/root']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/root']['criteria']['consumed_item'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/safely_harvest_honey']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/safely_harvest_honey']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/safely_harvest_honey']['criteria']['safely_harvest_honey'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/breed_an_animal']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/breed_an_animal']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/breed_an_animal']['criteria']['bred'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/tame_an_animal']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/tame_an_animal']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/tame_an_animal']['criteria']['tamed_animal'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/fishy_business']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/fishy_business']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/fishy_business']['criteria']['cod'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/silk_touch_nest']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/silk_touch_nest']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/silk_touch_nest']['criteria']['silk_touch_nest'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/plant_seed']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/plant_seed']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/plant_seed']['criteria']['wheat'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/bred_all_animals']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/bred_all_animals']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td class=""><?php echo '
<div class="ui list">
<div class="item">';
...
'; ?> </td>
                    ...
                    <tr>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/complete_catalogue	']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/complete_catalogue	']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td class=""><?php echo '
<div class="ui list">
<div class="item">';
...
'; ?> </td>
                    ...
                    <tr>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/tactical_fishing']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/tactical_fishing']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/tactical_fishing']['criteria']['pufferfish_bucket'],true),true));?>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/balanced_diet']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/balanced_diet']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td class=""><?php echo '
<div class="ui list">
<div class="item">';
...
'; ?></td>
                    ...
                    <tr>
                        ...
                        <td
                            class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/break_diamond_hoe']['done'])))){ echo "positive"; }else{ echo "negative"; };?>">
                            <?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/break_diamond_hoe']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?>
                        </td>
                        <td><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:husbandry/break_diamond_hoe']['criteria']['broke_hoe'],true),true));?>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="content">
                <table class="ui celled table" width="100%">
                    <tr>
                        <td><?php echo '挖掘的石头:'.json_decode($dkjson['stats']['minecraft:mined/minecraft:stone']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '挖掘的煤矿石:'.json_decode($dkjson['stats']['minecraft:mined/minecraft:coal_ore']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '挖掘的铁矿石:'.json_decode($dkjson['stats']['minecraft:mined/minecraft:iron_ore']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '挖掘的金矿石:'.json_decode($dkjson['stats']['minecraft:mined/minecraft:gold_ore']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '挖掘的红石矿石:'.json_decode($dkjson['stats']['minecraft:mined/minecraft:redstone_ore']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '挖掘的绿宝石矿石:'.json_decode($dkjson['stats']['minecraft:mined/minecraft:emerald_ore']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '挖掘的钻石矿石:'.json_decode($dkjson['stats']['minecraft:mined/minecraft:diamond_ore']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td>总挖矿数量:<?php echo $total; ?></td>
                    </tr>
                    <tr>
                        <td>钻石在所有矿石中所占比例:<?php if ($recaptcha->score >= 0.6){echo $diamond_ch.'%';}?></td>
                    </tr>
                    <tr>
                        <td>钻石在所有矿石中所占比例(除去原矿放置):<?php if ($recaptcha->score >= 0.6){echo $diamond_ch_exp_used.'%';}?>
                        </td>
                    </tr>
                    <tr>
                        <td>钻石占煤的比例:<?php if ($recaptcha->score >= 0.6){echo $coal_diamond.'%';} ?></td>
                    </tr>
                    <tr>
                        <td>钻石占铁的比例:<?php if ($recaptcha->score >= 0.6){echo $iron_diamond.'%';} ?></td>
                    </tr>
                    <tr>
                        <td>钻石占石头的比例:<?php if ($recaptcha->score >= 0.6){echo $diamond_stone.'%';} ?></td>
                    </tr>
                    <tr>
                        <td>矿物占石头的比例:<?php if ($recaptcha->score >= 0.6){echo $ore_stone.'%';} ?></td>
                    </tr>
                    <tr>
                        <td><b>注:以上数据均不包含下界石英数量</b></td>
                    </tr>
                </table>
            </div>
            ...
            <div class="content">
                <table class="ui celled table" width="100%">
                    <tr>
                        <td><?php echo '游戏退出次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:leave_game']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '游戏时间(秒):'.json_decode($dkjson['stats']['minecraft:custom/minecraft:play_one_minute']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '上次死亡时间:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:time_since_death']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '距离上次休息:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:time_since_rest']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '潜行时间	:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:sneak_time']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '行走距离:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:walk_one_cm']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '潜行距离:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:crouch_one_cm']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '疾跑距离:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:sprint_one_cm']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '游泳距离:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:swim_one_cm']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '掉落高度:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:fall_one_cm']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '攀爬高度:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:climb_one_cm']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '飞行距离:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:fly_one_cm']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '水下移动距离:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:walk_on_water_one_cm']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '坐矿车移动距离:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:minecart_one_cm']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '坐船移动距离:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:boat_one_cm']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '骑猪移动距离:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:pig_one_cm']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '骑马移动距离:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:horse_one_cm']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '鞘翅飞行距离:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:aviate_one_cm']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '跳跃次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:jump']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '造成伤害:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:damage_dealt']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '造成伤害(被吸收):'.json_decode($dkjson['stats']['minecraft:custom/minecraft:damage_dealt_absorbed']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '造成伤害(被抵挡):'.json_decode($dkjson['stats']['minecraft:custom/minecraft:damage_dealt_resisted']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '受到伤害:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:damage_taken']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '吸收的伤害:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:damage_absorbed']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '抵挡的伤害:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:damage_resisted']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '盾牌抵挡的伤害:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:damage_blocked_by_shield']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '总死亡次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:deaths']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '生物击杀次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:mob_kills']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '玩家击杀次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:player_kills']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '物品掉落次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:drop']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '物品附魔次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:enchant_item']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '生物繁殖次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:animals_bred']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '捕鱼次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:fish_caught']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '村民对话次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:talked_to_villager']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '村民交易次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:traded_with_villager']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '吃掉的蛋糕片数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:eat_cake_slice']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '炼药锅装水次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:fill_cauldron']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '炼药锅取水次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:use_cauldron']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '清洗盔甲次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:clean_armor']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '清洗旗帜次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:clean_banner']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '清洗潜影盒次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:clean_shulker_box']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '酿造台互动次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:interact_with_brewingstand']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '信标互动次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:interact_with_beacon']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '工作台互动次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:interact_with_crafting_table']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '熔炉互动次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:interact_with_furnace']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '高炉互动次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:interact_with_blast_furnace']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '营火互动次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:interact_with_campfire']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '制图台互动次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:interact_with_cartography_table']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '讲台互动次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:interact_with_lectern']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '织布机互动次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:interact_with_loom']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '烟熏炉互动次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:interact_with_smoker']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '切石机互动次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:interact_with_stonecutter']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '搜查发射器次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:inspect_dispenser']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '搜查投掷器次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:inspect_dropper']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '搜查漏斗次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:inspect_hopper']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '打开箱子次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:open_chest']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '陷阱箱触发次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:trigger_trapped_chest']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '打开末影箱次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:open_enderchest']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '打开木桶次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:open_barrel']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '音符盒播放次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:play_noteblock']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '音符盒调整次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:tune_noteblock']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '盆栽种植次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:pot_flower']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '播放唱片次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:play_record']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '躺在床上的次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:sleep_in_bed']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '打开潜影盒次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:open_shulker_box']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '鸣钟次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:bell_ring']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '触发袭击次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:raid_trigger']); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo '袭击胜利次数:'.json_decode($dkjson['stats']['minecraft:custom/minecraft:raid_win']); ?>
                        </td>
                    </tr>
                </table>
            </div>
    ...
    <div class="ui container center aligned footer">
        <div class="container">
            <p>Data Sources: <a href="https://api.mojang.com">Mojang Public API</a> & <a
                    href="https://stats.craft.moe">NyaaStats</a> & <a href="https://crafatar.com">Crafatar</a></p>
        ...
        let skinViewer = new skinview3d.SkinViewer({
            ...
            width: 250,
            height: 300,
            skinUrl: "<?php if(!empty($_POST["
            post "])){echo "
            https: //crafatar.com/skins/". json_decode(json_encode($dkjson['data']['uuid']));} else {echo "fallback.png";} //fallback可以使用任何皮肤 ?>"
        });
