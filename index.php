...
<div class="ui container">
  ...
  <div class="content">
    <table class="ui celled table" width="100%">
         ...
         <tr><td>怪物狩猎完成</td><td class="<?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/kill_all_mobs']['done'])))){ echo "positive"; }else{ echo "negative"; };?>"><?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/kill_all_mobs']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?></td><td class=""><?php echo '
<div class="ui list">
<div class="item">';
