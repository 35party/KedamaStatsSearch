    ...
    <div class="card">
      ...
      <div id="collapseO" class="collapse" data-parent="#accordion">
        <div class="card-body">
         ...
         <tr><td height="30px">扣下悬刀</td><td height="30px"><?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/ol_besty']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?></td><td height="30px"><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/ol_besty']['criteria']['ol_besty'],true),true));?></td></tr>
         <tr><td height="30px">现在谁才是掠夺者？</td><td height="30px"><?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/whos_the_pillager_now	']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?></td><td height="30px"><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:minecraft:adventure/whos_the_pillager_now	']['criteria']['kill_pillager'],true),true));?></td></tr>
         <tr><td height="30px">一箭双雕</td><td height="30px"><?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/two_birds_one_arrow']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?></td><td height="30px"><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/two_birds_one_arrow']['criteria']['two_birds'],true),true));?></td></tr>
         <tr><td height="30px">劲弩手</td><td height="30px"><?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/arbalistic']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?></td><td height="30px"><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/arbalistic']['criteria']['arbalistic'],true),true));?></td></tr>
         <tr><td height="30px">自我放逐</td><td height="30px"><?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/voluntary_exile']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?></td><td height="30px"><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/voluntary_exile']['criteria']['voluntary_exile'],true),true));?></td></tr>
         <tr><td height="30px">村庄英雄</td><td height="30px"><?php if(!empty(json_decode(json_encode($dkjson['advancements']['minecraft:adventure/hero_of_the_village']['done'])))){ echo "已完成"; }else{ echo "未完成"; };?></td><td height="30px"><?php print_r (json_decode(json_encode($dkjson['advancements']['minecraft:adventure/hero_of_the_village']['criteria']['hero_of_the_village'],true),true));?></td></tr>
    ...
    <div class="card">
      ...
      <div id="collapseT" class="collapse" data-parent="#accordion">
        <div class="card-body">
          ...
          <tr><td height="30px">矿物占石头的比例:<?php if ($recaptcha->score >= 0.6){echo $ore_stone.'%';} ?></td></tr>
