    ...
    ?>
        <form class="ui form" method="post" id="form">
            ...
            <span style="font-size:14px;">
                <div class="g-recaptcha" data-callback="recaptcha_callback" data-sitekey="your-public-key"></div>
            </span><br>
...
'; ?></td>
            ...
            <div class="content">
                <table class="ui celled table" width="100%">
                    ...
                    <tr>
                        <td>钻石在所有矿石中所占比例:<?php if(!empty(json_decode($recaptcha_result['success']))){echo $diamond_ch.'%';}?>
                        </td>
                    </tr>
                    <tr>
                        <td>钻石在所有矿石中所占比例(除去原矿放置):<?php if(!empty(json_decode($recaptcha_result['success']))){echo $diamond_ch_exp_used.'%';}?>
                        </td>
                    </tr>
                    <tr>
                        <td>钻石占煤的比例:<?php if(!empty(json_decode($recaptcha_result['success']))){echo $coal_diamond.'%';} ?>
                        </td>
                    </tr>
                    <tr>
                        <td>钻石占铁的比例:<?php if(!empty(json_decode($recaptcha_result['success']))){echo $iron_diamond.'%';} ?>
                        </td>
                    </tr>
                    <tr>
                        <td>钻石占石头的比例:<?php if(!empty(json_decode($recaptcha_result['success']))){echo $diamond_stone.'%';} ?>
                        </td>
                    </tr>
                    <tr>
                        <td>矿物占石头的比例:<?php if(!empty(json_decode($recaptcha_result['success']))){echo $ore_stone.'%';} ?>
                        </td>
                    </tr>
                    <tr>
